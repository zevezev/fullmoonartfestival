export const FloweringMoon = () => {
  return (
    <>
      ...
      <div>
        We'll progress through the three fountains as the sun goes down, each
        with a different art ritual collaboration.
      </div>
      <div>
      ...
      <div>
        There will be picnic-style snacks. Feel free to bring whatever food or
        materials you'd like to the space.
      </div>
      <div>
        If you want help finding us, a participant will guide folks to the
        fountains from the Grand Army Plaza Gazebo nearest to the library at 5.
      </div>
      <div>Contact</div>
